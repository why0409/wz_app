 ...
 * @date 2024-07-31
 */
public class QuestionnaireInfoVo extends BaseEntity
{
    ...
    private QuestionnaireGiftInfoVo giftInfo;
    ...
    public QuestionnaireGiftInfoVo getGiftInfo() {
        return this.giftInfo;
    }

    public void setGiftInfo(QuestionnaireGiftInfoVo giftInfo) {
